...
\setmainfont[Ligatures={TeX,Historic}]{Calibri}
...
\begin{document}
	...
	\fancyfoot[R]{\textcolor{black}{ИП Мраморнов А.В.}}
...
\end{tcolorbox}
\vspace{-5mm}
\noindent \textbf{Марка, модель:}\,\тс \\
\noindent \textbf{VIN:}\,{\vin} \\  
\noindent \textbf{Номер кузова:}\,{\vin} \hfill \textbf{Номер шасси:}\, отсутствует\\  
\textbf{Регистрационный знак:}\,\grz \hfill \textbf{ПТС:}\, \птс \hfill \textbf{Пробег, км:}\,\пробег\\
...
\noindent \textbf{Собственник ТС:\,}\владелец\\
\textbf{Доверенное лицо:}\, \заказчик\\
\textbf{Адрес собственника ТС, доверенного лица:}\, \адресвладельца\\
\textbf{Другие заинтересованные лица:}\, \\
...
{\footnotesize \textbf{\textit{{Характер описанных повреждений даёт основание предварительно установить, что все они могут принадлежать
				...
				виды ремонтных воздействий исходя из технологических и конструктивных особенностей ТС. Принятые сокращения: E-замена, I- ремонт, L-окраска,  ЛКП - лакокрасочное
				покрытие, Л-левая сторона, П- правая сторона, КПП - коробка перемены передач, ДВС- двигатель внутреннего сгорания}}}}
\end{tcolorbox}
\end{spacing}
\vspace{2mm}

\noindent ТС подлежит ремонту:\,\, ДА\, {\large \чек}\,\,\, НЕТ {\large \чек}\\
\noindent Скрытые повреждения, возможные  в зоне основных повреждений: \rule{50mm}{0.1mm}\\
\rule{170mm}{0.1mm}
\rule{170mm}{0.1mm}
...
\hspace{10.5cm} {\scriptsize  Подпись}
...
\hspace{13cm} {\scriptsize  Подпись}
