...
%		\centering{\includegraphics[width=1\linewidth]{1}} a) \\
%	\end{minipage}
%	\hfill
%	\begin{minipage}[h]{0.47\linewidth}
%		\centering{\includegraphics[width=1\linewidth]{1}} \\b)
%	\end{minipage}
%	\vfill
%	\begin{minipage}[h]{0.47\linewidth}
%		\centering{\includegraphics[width=1\linewidth]{1}} c) \\
%	\end{minipage}
%	\hfill
%	\begin{minipage}[h]{0.47\linewidth}
%		\centering{\includegraphics[width=1\linewidth]{1}} d) \\
%	\end{minipage}
...
%	\hspace{4ex}
%	\subfigure[]{ \includegraphics[width=0.24\linewidth]{1} \label{fig:actuatorscouplingSheme_nearestcoupled_and_diag_case} }  
